...
namespace TeknikDestek1.Controllers
{
    public class DocumentController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DocumentName,DocumentDate,DocumentSubject,DocumentInfo,DocumentBanner,DocumentVideo,References,WriterId,CategoryId")] Document document)
        {
            if (id != document.Id)
            {
                return NotFound();
